...
## Rest
Representational State Transfer의 약자로 분산 하이퍼미디어 시스템을 위한 소프트웨어 아키텍처이다.
...
3. 5XX 에러는 절대 사용자에게 나타내지 않는다!
    ...
    API Server level에서는 500 에러가 나서는 안 된다.(서비스 장애)<br>
    즉, API Server는 모든 발생 가능한 에러를 핸들링해야 한다.<br>
